...
export class Resolver {
  ...
  async process(input: unknown): Promise<Record<string, unknown>> {
    ...
    return { status: "success", module: "Resolver", result };
  }
  ...
  getStatus(): Record<string, unknown> {
    return { module: "Resolver", initialized: this.initialized, dataKeys: [...this.data.keys()] };
  }
